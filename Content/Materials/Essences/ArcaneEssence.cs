...
{
    internal class ArcaneEssence : ModItem
    {
        public override string Texture => "ForgottenFacets/Assets/Materials/Essences/ArcaneEssence";
        ...
        public override void SetStaticDefaults()
        {
            ...
            Main.RegisterItemAnimation(Type, new DrawAnimationVertical(8, 32));
        }
