...
{
    internal class AncientIceOre : ModItem
    {
        public override string Texture => "ForgottenFacets/Assets/Materials/Ores/AncientIceOre";
        ...
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<AncientIceOreTile>());
            Item.sellPrice(silver: 1, copper: 50);
            Item.rare = ItemRarityID.Blue;
        }
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            Texture2D tex = ModContent.Request<Texture2D>("ForgottenFacets/Assets/Materials/Ores/AncientIceOre").Value;
            Texture2D outline = ModContent.Request<Texture2D>("ForgottenFacets/Assets/Materials/Ores/AncientIceOre_Outline").Value;
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            ...
            Main.spriteBatch.Draw(outline, Item.Center - Main.screenPosition + new Vector2(0, -1), null, Color.White * sin, rotation, outline.Size() / 2f, scale, 0f, 0f);
        }
